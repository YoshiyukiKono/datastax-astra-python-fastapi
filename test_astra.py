...
ASTRA_DB_KEYSPACE = "test" #os.environ.get('ASTRA_DB_KEYSPACE')
# create table member (id text primary key, first_name text, last_name text, emails List<text>);
ASTRA_DB_COLLECTION = "member"#"test"
